...
[설계서 v1.1](docs/6반_3조_설계서_v1.1.docx)은 설명 문구를 정리한 개정본입니다. [초안 v1](docs/6반_3조_설계서_v1.docx)도 보관합니다. 기능 요건과 테스트 기준은 이번 문구 수정에서 변경하지 않았습니다. [설계서와 코드의 대응 및 미확정 사항](docs/README.md)을 함께 확인하세요.
